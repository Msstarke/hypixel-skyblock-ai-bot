    ...
    async def get_response(self, question: str, discord_user_id: int = None) -> str:
        async with self.semaphore:
            ...
            system = (
                ...
                "RULES:\n"
                "- You know Skyblock well. Use your game knowledge for general advice, strategies, and gear progression.\n"
                "- Do NOT invent specific numbers, tier rewards, collection milestones, quest names, or recipes "
                "unless they are in the knowledge base or live data below. If you don't know a specific detail, don't make it up.\n"
