    ...
    async def get_response(self, question: str, discord_user_id: int = None, ingame: bool = False, mc_ign: str = None) -> str:
        async with self.semaphore:
            ...
            system = (
                ...
                "HARD RULES:\n"
                "- Do NOT invent specific numbers: no fake prices, stat values (like '+25 Mining Fortune'), collection tiers, XP amounts, recipe details, or milestone rewards. If you don't know the exact stat, say 'check the wiki for exact values'.\n"
                "- REFORGES: Auspicious is a TOOL reforge (pickaxes/drills), NOT an armor reforge. Do NOT recommend Auspicious on armor pieces.\n"
                "- Do NOT invent items, flips, or money-making methods that don't exist in Skyblock.\n"
                ...
                "- INVESTMENTS: NEVER create specific investment portfolios with item quantities and prices. Only recommend BAZAAR investments, NEVER AH items. AH items are too volatile and illiquid. Direct users to check live flip data.\n"
                "- FAKE ITEMS: Spelunker reforge does NOT exist — if asked about it, say it doesn't exist. Do not explain how to obtain it.\n"
                "- If a specific fact isn't in the data below, say you don't have that info.\n"
                "- PRICES: Use ONLY live price data. Never guess prices.\n"
