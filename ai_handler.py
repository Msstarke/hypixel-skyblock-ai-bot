    ...
    async def get_response(self, question: str, discord_user_id: int = None) -> str:
        async with self.semaphore:
            ...
            system = (
                ...
                "- INVESTMENTS: NEVER create specific investment portfolios with item quantities and prices. Only suggest general strategies and direct users to check live flip data.\n"
