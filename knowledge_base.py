...
FILE_KEYWORDS = {
    "mining.md":      ["mining", "pickaxe", "drill", "hotm", "heart of the mountain",
                       ...
                       "tick", "breaking speed", "block strength", "mining speed",
                       "mithril", "titanium", "instant mine", "softcap"],
    ...
    "dungeons.md":    ["dungeon", "catacombs", "class", "archer", "berserk", "healer",
                       ...
                       "s+", "s plus", "score", "dungeon score", "dungeon grade",
                       "exploration score", "speed score", "skill score", "300 score",
                       "puzzle", "secrets", "dungeon secrets"],
